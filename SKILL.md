...
name: parallux
description: >-
  Build cinematic Awwwards-quality animated websites. Covers Lenis smooth scroll, GSAP ScrollTrigger timelines, per-letter mask reveals, WebGL noise-distortion images, interactive particle fields, elastic cursor followers, SVG progress ring preloaders, flip cards, velocity marquees, magnetic cursor, sticky stacking cards, clip-path morphs, and 3D/WebGL heroes. Trigger on: animated website, Awwwards site, scroll animation, agency site, portfolio, GSAP landing page, parallax site, WebGL site, interactive website, or any scroll-driven motion request. Uses Lenis + GSAP as baseline, adds canvas/WebGL when it elevates the piece, auto-sources stock photos from Pexels and Unsplash when no assets are provided.
---
